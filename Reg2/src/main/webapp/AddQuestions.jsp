...
Options:
<input type="checkbox" id="chkOp1"   onclick="fun()"  for="options[0].description"> <input type="text" name = "options[0].description" id="lbl1"><br/> 
<input type="checkbox" id="chkOp2"   onclick="fun()"  for="options[1].description"><input type="text" name = "options[1].description" id="lbl2"><br/>
<input type="checkbox" id="chkOp3"   onclick="fun()"  for="options[2].description"><input type="text" name = "options[2].description" id="lbl3"><br/>
<input type="checkbox" id="chkOp4"   onclick="fun()" for="options[3].description"><input type="text" name = "options[3].description" id="lbl4"><br/>

<input type="text" id="opt" value="res opt"/>
